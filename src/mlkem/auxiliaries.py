...
# --- FIPS203 Section 4: Auxiliary Algorithms ---
# Pure NIST FIPS 203 implementation — no hardware tracing or modifications.
# For instrumented/traced versions see trace_auxiliaries.py.
...
# FIPS203 Algorithm 5 — Compress_d
...
# FIPS203 Algorithm 5 — Decompress_d
